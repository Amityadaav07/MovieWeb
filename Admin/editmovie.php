...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="text" name="mv_m_desc" value="<?php echo$row['meta_desciption'] ?>" class="form-control" placeholder="Enter meta description" >
  </div>
    <div class="form-group">
...
if (isset($_POST['submit'])) {
  ...
  if ($newimg != '') {
    ...
    $query1 = " UPDATE `movie` SET `cat_id`=$cat_id,`genre_id`=$genre_id,`mv_name`='$mv_name',`mv_des`='$mv_desc',`mv_tag`='$mv_m_tag',`link1`='$mv_link1',`link2`='$mv_link2',`img`='$update_filename',`date`='$mv_date',`lang`='$mv_lang',`director`='$mv_director',`meta_desciption`='$mv_m_desc' WHERE id = $id ";
