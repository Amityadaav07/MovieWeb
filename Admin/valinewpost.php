...
if (isset($_POST['submit'])) {
	...
	$query = "INSERT INTO movie (`cat_id`, `genre_id`, `mv_name`, `mv_des`, `mv_tag`, `link1`, `link2`, `img`, `date`, `lang`, `director`, `meta_desciption`) VALUES ($cat_id,$genre_id,'$mv_name','$mv_desc','$mv_m_tag','$mv_link1','$mv_link2','$img','$mv_date','$mv_lang','$mv_director','$mv_m_desc')";
